...
public class UnitworkController {
   ...
   public UnitworkController(UnitworkService unitworkService) {
     ...
     public String showList(Model model, @RequestParam("PJ_NUM") int PJ_NUM) {
     ...
     @ResponseBody
     public List<Unitwork> loadUnitworkData(Model model, @RequestParam("PJ_NUM") int PJ_NUM) {
   ...
   @ResponseBody
   public String updateUnitwork(Model model, @RequestParam("PJ_NUM") int PJ_NUM, @RequestParam("uw_NUM") int UW_NUM,
